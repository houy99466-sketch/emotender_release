...
MOOD_TO_CATEGORIES = {
    "焦虑": ["经典牛乳鲜奶茶", "纯原叶无添加纯茶", "抹茶&可可浓醇系列"],
    "难过": ["经典牛乳鲜奶茶", "抹茶&可可浓醇系列", "生打椰椰系列"],
    "兴奋": ["招牌芝芝鲜果茶", "生打椰椰系列", "时令季节限定"],
    "疲惫": ["生打椰椰系列", "纯原叶无添加纯茶", "经典牛乳鲜奶茶"],
    "清醒": ["纯原叶无添加纯茶", "喜乐芝纯茶奶盖", "招牌芝芝鲜果茶"],
    "犹豫": ["招牌芝芝鲜果茶", "经典牛乳鲜奶茶", "喜乐芝纯茶奶盖"],
}
...
def get_eligible_categories(emotion_label: str) -> list[str]:
    """从情绪标签获取适配的饮品分类列表"""
    return MOOD_TO_CATEGORIES.get(emotion_label, ["招牌芝芝鲜果茶", "经典牛乳鲜奶茶"])
